...
export const site = {
  ...
  intro: [
    ...
    "Behavioural modelling is the specialisation underpinning my ML career: activity recognition from wearable and in-home sensors, behavioural signatures of early-stage dementia, personalised search and recommendation, and models of customer behaviour built from logged interactions. Those domains share no data and no evaluation protocol, but they pose the same problem: behaviour is soft and it shifts underneath a model, so I build systems that adapt to it while holding guarantees strong enough to prove in an online test, and to move the numbers the business cares about.",
  ],
} as const;
