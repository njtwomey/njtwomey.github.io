...
Several things contribute to complex paths, and complex paths can not only jeopardise model fit but will also require more time (evaluations) to determine solutions. Two complexity-inducing aspects that we penalise in our models are
